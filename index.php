...
<body>
    ...
    <div class="nav_links"></div>
      ...
      if($conn === false){
		...
		$sql = "SELECT * FROM data WHERE status='1' ORDER BY id DESC";
      $result = $conn->query($sql);
	  echo '<div class="rec-post"><ul>';
	  
    while($row = mysqli_fetch_array($result)){
		$idd=$row['id'];
		echo "<li><a href='post.php?idd=".$idd."&style=none'>".$row['title']."</a></li>";
    ...
    while($row = mysqli_fetch_array($result)){
        ...
        echo '
                ...
                <p><a href='post.php?idd=".$idd."&style=none'>View More</a>&nbsp&nbsp&nbsp&nbsp&nbsp Total Number of Views:-".$row['downloads']."  &nbsp&nbsp&nbsp Uploaded on:- ".$row['date'].'</p> </td>
                </tr>      
       ';
